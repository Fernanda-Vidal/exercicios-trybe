...
# Factory Method: é um padrão que implementa uma interface responsável por
# fabricar/criar outros objetos.

# Abstract Factory: é um padrão que permite produzir famílias de objetos
# relacionados.
