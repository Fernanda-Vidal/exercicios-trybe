...
# A sobrescrita ocorre quando um método definido em uma superclasse
# é novamente definido (reescrito/sobrescrito) na subclasse.
...
class Liquidificador2(Eletrodomestico):
    def esta_ligado(self):
...
# Se você quiser sobrescrever métodos decorados com o @property,
# precisará fazer algumas adaptações na superclasse.
