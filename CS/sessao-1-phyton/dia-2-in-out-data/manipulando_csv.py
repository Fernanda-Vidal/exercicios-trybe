...
with open("graduacao_unb.csv", encoding = "utf-8") as file: # Caso o argumento 'encoding' não seja passado, será utilizado o decodificador padrão do sistema para .csv
