...
const damageDragon = (dragon) => {
  const min = 15;
    console.log(Math.floor(Math.random() * (dragon.strength - min + 1) + min));
}
...
const damageWarrior = () => {
  console.log(Math.floor(Math.random() * (warrior.strength * warrior.weaponDmg - warrior.strength) + warrior.strength))
}
