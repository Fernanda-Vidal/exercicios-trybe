...
const email2 = new Email(friendEmail, myEmail, 'Reply - Car wash', 'Great! My ar is really dirty. How much do they charge?');
...
console.log('------------personalMailList.getEmailsSentBy(\'me@personalmail.com\'):');
